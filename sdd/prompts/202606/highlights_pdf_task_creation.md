---
plan: sdd/tales/202606/highlights_pdf_task_creation.md
---
...
- For each task bullet note in a PDF that is found, a new Obsidian task should be created in the reference note file
  corresponding with that PDF (under the `^task` task).
- For example, `- #task Foo bar baz` should triggered the creation of a new `- #task Foo bar baz [created::2026-06-07]`
  line in the reference note file.
